...
ArduinoSdMmcFs::ArduinoSdMmcFs(uint8_t clk, uint8_t cmd, uint8_t d0,
                               const char* mountpoint, int frequency,
...
ArduinoSdMmcFs::ArduinoSdMmcFs(uint8_t clk, uint8_t cmd, uint8_t d0, uint8_t d1,
                               uint8_t d2, uint8_t d3, const char* mountpoint,
...
void ArduinoSdMmcFs::unmountImpl() { SD_MMC.end(); }

// ArduinoSdMmcFs SdMmc;
