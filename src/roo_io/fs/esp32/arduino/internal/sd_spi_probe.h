...
//
// SdSpiCheckStatus(): Sends CMD13 (SEND_STATUS) and checks for a valid R1.
// Non-destructive — safe to call while a filesystem is mounted.
//
...
// Returns true if a mounted card responds to CMD13 (SEND_STATUS).
// Non-destructive — does not reset the card.
