...
#include "roo_io/reliable/bidi_streaming/internal/protocol.h"
...
void Channel::begin() {
  ...
  xTaskCreate(&MySendLoop, "send_loop", 4096, this, 1,  // tskIDLE_PRIORITY,
              &xHandle);

  // sender_thread_ = std::thread(SendLoop, this);
}
